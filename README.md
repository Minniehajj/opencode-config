...
**Q: Do I need to install optional tools?**  
A: No, they're optional. Only install if you want Gemini AI features.
...
Everything included - all agents, subagents, and tools.
