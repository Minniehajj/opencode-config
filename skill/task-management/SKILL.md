...
bash skill/task-management/router.sh status

# Show next eligible tasks
bash skill/task-management/router.sh next

# Show blocked tasks
bash skill/task-management/router.sh blocked

# Mark a task complete
bash skill/task-management/router.sh complete <feature> <seq> "summary"

# Validate all tasks
bash skill/task-management/router.sh validate
```
...
```bash
$ bash skill/task-management/router.sh complete my-feature 05 "Implemented authentication module"

[OK] Marked my-feature/05 as completed
...
```bash
$ bash skill/task-management/router.sh deps my-feature 07

=== Dependency Tree: my-feature/07 ===

07 - Write integration tests [pending]
  |- [OK] 05 - Implement authentication module [completed]
...
```bash
bash skill/task-management/router.sh validate my-feature
```
...
bash skill/task-management/router.sh status my-feature

# See what's next
bash skill/task-management/router.sh next my-feature

# Check what's blocked
bash skill/task-management/router.sh blocked my-feature
```
...
bash skill/task-management/router.sh complete my-feature 05 "Implemented auth module with JWT support"
...
bash skill/task-management/router.sh parallel my-feature
```
...
- Router: `skill/task-management/router.sh`
- CLI: `skill/task-management/scripts/task-cli.ts`
- Tasks: `.tmp/tasks/` (created by TaskManager)
- Documentation: `skill/task-management/SKILL.md` (this file)
